...
string Float(float f, integer integerOk)
{
    ...
    if(f == llCeil(TWO_PI * 1000) * .001) return "TWO_PI";
    if(f == llCeil(-TWO_PI * 1000) * .001) return "-TWO_PI";
    if(f == llCeil(PI * 1000) * .001) return "PI";
    if(f == llCeil(-PI * 1000) * .001) return "-PI";
    if(f == llCeil(PI_BY_TWO * 1000) * .001) return "PI_BY_TWO";
    if(f == llCeil(-PI_BY_TWO * 1000) * .001) return "-PI_BY_TWO";
    if(f == llCeil(RAD_TO_DEG * 1000) * .001) return "RAD_TO_DEG";
    if(f == llCeil(-RAD_TO_DEG * 1000) * .001) return "-RAD_TO_DEG";
    if(f == llCeil(DEG_TO_RAD * 1000) * .001) return "DEG_TO_RAD";
    if(f == llCeil(-DEG_TO_RAD * 1000) * .001) return "-DEG_TO_RAD";
